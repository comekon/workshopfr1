...
<div class="card">
    <div class="card-body">
        <h4 class="card-title">Tambah Customer 1 (Foto BLOB)</h4>
        <p class="text-muted">Foto akan disimpan sebagai data BLOB dalam database</p>

        <form action="{{ route('customer.store1') }}" method="POST" id="formCustomer">
            @csrf
